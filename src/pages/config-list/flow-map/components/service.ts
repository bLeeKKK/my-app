...
// 获取流程
export async function findOne(data: ParamsType): Promise<{ success: boolean; data: unknown[] }> {
  return request(`${SERVER_PATH}/${BIZLOG_CORE}/businessFlowConfig/findOne`, {
    method: 'GET',
    params: data,
  });
}
...
// 大节点-保存
export async function businessFlowMajorNodeSave(data) {
  return request(`${SERVER_PATH}/${BIZLOG_CORE}/businessFlowMajorNode/save`, {
    method: 'POST',
    data,
  });
}
