...
// 导出接口记录池数据
export async function exportZongheReverse(data: ParamsType): Promise<{ data: unknown[] }> {
  return request(`${SERVER_PATH}/${BIZLOG_CORE}/fullLinkRecord/exportZongheReverse`, {
    method: 'POST',
    responseType: 'blob',
    data,
  });
